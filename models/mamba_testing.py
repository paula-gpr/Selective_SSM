...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, batch_size=8, collate_fn=custom_collate_fn,num_workers=4, pin_memory=True, shuffle=True)
    val_loader = DataLoader(val_dataset, batch_size=8, collate_fn=custom_collate_fn,num_workers=4, pin_memory=True, shuffle=False)
    test_loader = DataLoader(test_dataset, batch_size=8, collate_fn=custom_collate_fn, num_workers=4, pin_memory=True, shuffle=False)
